...
def plot_results(results, output_path):
    ...
    ax.set_title("6-node Spain: Objective Comparison", fontsize=16, fontweight="bold", pad=15)
...
def plot_time_results(results, output_path):
    ...
    ax.set_title("6-node Spain: Computation Time BLOND vs MIP", fontsize=16, fontweight="bold", pad=15)
    ax.set_xticks(budgets)
    ax.tick_params(axis="both", which="major", labelsize=12)
