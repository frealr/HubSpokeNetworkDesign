...
def plot_results(results, output_path):
    ...
    mip_reported_gap[np.abs(mip_reported_gap) < 1e-12] = 0.0
    ...
    ax.set_title("4-node Spain: Objective Comparison", fontsize=16, fontweight="bold", pad=15)
...
def plot_time_results(results, output_path):
    ...
    ax.set_title("4-node Spain: Computation Time BLOND vs MIP", fontsize=16, fontweight="bold", pad=15)
    ax.set_xticks(budgets)
    ax.tick_params(axis="both", which="major", labelsize=12)
